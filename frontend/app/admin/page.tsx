...
// CreateAlbumDialog Component (your existing code)
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <div className="space-y-4 mb-4">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setAlbumData((prev) => ({ ...prev, description: e.target.value }))
                }
  ...
  const handleEditSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8080/api/albums/${editAlbum.id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          {albums.map((album) => (
            <Card key={album.id} className="relative">
              ...
              <CardContent>
                ...
                <p>{album.date}</p>
                <Badge>{album.number_of_images} images</Badge>
        ...
        <DialogContent>
          ...
          <form onSubmit={handleEditSubmit}>
            <Input
              ...
              onChange={(e) =>
                setEditAlbum((prev) => ({ ...prev!, name: e.target.value }))
              }
              placeholder="Album Name"
              required
            />
            ...
            <Input
              ...
              onChange={(e) =>
                setEditAlbum((prev) => ({ ...prev!, date: e.target.value }))
              }
              required
            />
